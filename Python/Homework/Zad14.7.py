def poPrawej(macierz, indexWierszaLitera1, indexKolumnyLitera1, indexKolumnyLitera2):
    if indexKolumnyLitera1 - 1 == 0:
        indexKolumnyLitera1 = 6
    if indexKolumnyLitera2 - 1 == 0:
        indexKolumnyLitera2 = 6
...
def wDol(macierz, indexKolumnyLitera1, indexWierszaLitera1, indexWierszaLitera2):
    if indexWierszaLitera1 - 1 == 0:
        indexWierszaLitera1 = 6
    if indexWierszaLitera2 - 1 == 0:
        indexWierszaLitera2 = 6
